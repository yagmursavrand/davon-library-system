...
@NoArgsConstructor
@AllArgsConstructor
@ToString(exclude = {"profile", "userRole"}) // Exclude to prevent circular references
@EqualsAndHashCode(exclude = {"profile", "userRole"}) // Exclude to prevent circular references
public class User {
    @Id
